...
<div class="container" style="margin-top: 50px; width: 450px;">
    <div class="card">
        <img src="./images/us.png" style="height: 150px; width: 150px; margin-left: 130px" class="card-img-top"
            alt="...">
        <div class="card-body">
            ...
            <form action="scripts/login.php" method="post">
			 ...
			 <a  href="register.php"><br>Don't have an account,click here to register</a>
